...
public class ThemeManager {
    ...
    private void loadBoardThemes() {
        this.boardThemes = JsonLoader.loadResource("/board_themes.json", new TypeReference<Map<String, BoardTheme>>() {});
    }

    private void loadPieceSets() {
        this.pieceSets = JsonLoader.loadResource("/piece_sets.json", new TypeReference<Map<PieceSetType, Map<String, PieceSet>>>() {});
    }

    private void loadSoundSets() {
        this.soundSets = JsonLoader.loadResource("/sound_sets.json", new TypeReference<Map<String, SoundSet>>() {});
    }
    ...
    public String getBoardThemeName(BoardTheme boardTheme) {  // todo: replace with display-name property
